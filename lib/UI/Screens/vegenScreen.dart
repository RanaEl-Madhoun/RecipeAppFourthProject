...
class Vegentar extends StatelessWidget{
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 40,),
                    Text("Vegetariane Recipes",style: GoogleFonts.lora(fontWeight: FontWeight.w600,fontSize: 20),),
                ],
              ),
               GridView.builder(
                        shrinkWrap: true,
                          gridDelegate:
                                  ...
                                  // crossAxisCount: 2,
                                  primary: false,
                        itemCount:value.Vegtrn.length,
                     
                       itemBuilder: ( (context, index) {
                        if(value.Vegtrn.length==null){
                          return CircularProgressIndicator ();
                        }
                         return RecipenameWidgt(value.Vegtrn[index]);
