...
class Keto extends StatelessWidget{
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 40,),
                    Text("Ketogenatic Recipes",style: GoogleFonts.lora(fontWeight: FontWeight.w600,fontSize: 20),),
                ],
              ),
               GridView.builder(
                        shrinkWrap: true,
                          gridDelegate:
                                  ...
                                  // crossAxisCount: 2,
                                  primary: false,
                        itemCount:value.keto.length,
                     
                       itemBuilder: ( (context, index) {
                        if(value.keto.length==null){
                          return CircularProgressIndicator ();
                        }
                         return RecipenameWidgt(value.keto[index]);
