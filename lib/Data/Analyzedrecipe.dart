class AutogeneratedAnalyzed {
  String? name;
  List<Steps>? steps;

  AutogeneratedAnalyzed({this.name, this.steps});
  

  AutogeneratedAnalyzed.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    if (json['steps'] != null) {
      steps = <Steps>[];
  ...
  Steps.fromJson(Map<String, dynamic> json) {
    ...
    if (json['ingredients'] != null) {
      ...
      json['ingredients'].forEach((v) {
        ingredients!.add(new Ingredients2.fromJson(v));
      });
    }
    number = json['number'];
    step = json['step'];
...
class Ingredients2 {
  ...
  Ingredients2({this.id, this.image, this.name});
